package ezzetech.com.testgeofencing;
...
implements
    ...
    private Button buttonStartGeoLoc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStartGeoLoc = (Button)findViewById(R.id.btnGeoLocation);
        initGMaps();
        createGoogleApi();

        buttonStartGeoLoc.setOnClickListener(new View.OnClickListener() {
            @Override
